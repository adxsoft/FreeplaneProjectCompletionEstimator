...
<node TEXT="Project Completion Estimator v0.1&#xa;Developed by ADXSoft (Allan)&#xa;19th Jan 2017&#xa;&#xa;Demonstration of formulas with date arithmetic&#xa;All dates are in format dd-MM-yy&#xa;&#xa;Project Phases consisting of a number of tasks are&#xa;represented.&#xa;&#xa;Task completion data is rolled up into phases&#xa;&#xa;phase data is rolled up to provide a forecast project&#xa;finish and overrun status" LOCALIZED_STYLE_REF="defaultstyle.floating" POSITION="right" ID="ID_1845153634" CREATED="1484821144237" MODIFIED="1484821773254" HGAP_QUANTITY="519.2999752378475 pt" VSHIFT_QUANTITY="-142.19999321937595 pt" COLOR="#663300" BACKGROUND_COLOR="#ffffcc">
<hook NAME="FreeNode"/>
</node>
<node TEXT="Design Phase" LOCALIZED_STYLE_REF="defaultstyle.floating" FOLDED="true" POSITION="right" ID="ID_120008276" CREATED="1484731871164" MODIFIED="1484821581696" HGAP_QUANTITY="197.09999060154007 pt" VSHIFT_QUANTITY="-116.09999446392095 pt">
...
<attribute NAME="EffortLeft" VALUE="=children.sum(0){it[&apos;ETC&apos;].num0}" OBJECT="org.freeplane.features.format.FormattedFormula|=children.sum(0){it[&apos;ETC&apos;].num0}|#0.####"/>
...
<node TEXT="Design UI" ID="ID_602456289" CREATED="1484813796709" MODIFIED="1484814191923">
<icon BUILTIN="button_ok"/>
<attribute NAME="EffortDone" VALUE="6" OBJECT="org.freeplane.features.format.FormattedNumber|6|#0.####"/>
<attribute NAME="ETC" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
</node>
<node TEXT="Design Data Model" ID="ID_188599732" CREATED="1484813796709" MODIFIED="1484815537212">
<icon BUILTIN="50%"/>
<attribute NAME="EffortDone" VALUE="3" OBJECT="org.freeplane.features.format.FormattedNumber|3|#0.####"/>
<attribute NAME="ETC" VALUE="3" OBJECT="org.freeplane.features.format.FormattedNumber|3|#0.####"/>
</node>
<node TEXT="" ID="ID_353451125" CREATED="1484814121227" MODIFIED="1484814121227"/>
<node TEXT="Design Business Rules" ID="ID_692514953" CREATED="1484813796709" MODIFIED="1484820124833">
<icon BUILTIN="25%"/>
<attribute NAME="EffortDone" VALUE="2" OBJECT="org.freeplane.features.format.FormattedNumber|2|#0.####"/>
<attribute NAME="ETC" VALUE="4" OBJECT="org.freeplane.features.format.FormattedNumber|4|#0.####"/>
</node>
</node>
<node TEXT="Development Phase" LOCALIZED_STYLE_REF="defaultstyle.floating" FOLDED="true" POSITION="right" ID="ID_1189201179" CREATED="1484731871164" MODIFIED="1484821626050" HGAP_QUANTITY="260.9999875545508 pt" VSHIFT_QUANTITY="125.99999399185211 pt">
...
<node TEXT="Build Web GUI" ID="ID_100242209" CREATED="1484813796709" MODIFIED="1484815436581">
<icon BUILTIN="button_ok"/>
<attribute NAME="EffortDone" VALUE="12" OBJECT="org.freeplane.features.format.FormattedNumber|12|#0.####"/>
<attribute NAME="ETC" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
</node>
<node TEXT="Build Databasel" ID="ID_864201418" CREATED="1484813796709" MODIFIED="1484814680124">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="4" OBJECT="org.freeplane.features.format.FormattedNumber|4"/>
</node>
<node TEXT="Build Functions" ID="ID_168112776" CREATED="1484813796709" MODIFIED="1484814689821">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|#0.####"/>
</node>
</node>
<node TEXT="Testing Phase" LOCALIZED_STYLE_REF="defaultstyle.floating" FOLDED="true" POSITION="right" ID="ID_910598033" CREATED="1484731871164" MODIFIED="1484821679795" HGAP_QUANTITY="428.3999795722973 pt" VSHIFT_QUANTITY="16.199999227523886 pt">
...
<font BOLD="true"/>
<node TEXT="Test Web GUI" ID="ID_796075235" CREATED="1484813796709" MODIFIED="1484815431822">
<icon BUILTIN="button_ok"/>
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|#0.####"/>
</node>
<node TEXT="Test Databasel" ID="ID_1961780692" CREATED="1484813796709" MODIFIED="1484815409309">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="4" OBJECT="org.freeplane.features.format.FormattedNumber|4"/>
</node>
<node TEXT="Test Functions" ID="ID_390596058" CREATED="1484813796709" MODIFIED="1484815416781">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|#0.####"/>
</node>
</node>
...
<edge COLOR="#808080"/>
<node TEXT="First Phase" LOCALIZED_STYLE_REF="default" FOLDED="true" ID="ID_530025972" CREATED="1484731871164" MODIFIED="1484817137967" HGAP_QUANTITY="122.39999416351347 pt" VSHIFT_QUANTITY="-10.799999485015974 pt">
<attribute_layout NAME_WIDTH="60.299997124672075 pt" VALUE_WIDTH="60.299997124672075 pt"/>
<attribute NAME="EstStart" VALUE="18-01-17" OBJECT="org.freeplane.features.format.FormattedDate|2017-01-18T00:00+1100|dd-MM-yy"/>
<attribute NAME="EstEffort" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|##"/>
<attribute NAME="EstFinish" VALUE="=node[&apos;EstStart&apos;].to.date+node[&apos;EstEffort&apos;].to.num.intValue()" OBJECT="org.freeplane.features.format.FormattedFormula|=node[&apos;EstStart&apos;].to.date+node[&apos;EstEffort&apos;].to.num.intValue()|dd-MM-yy"/>
...
<node TEXT="Task 1 100% Complete" ID="ID_309489755" CREATED="1484813796709" MODIFIED="1484816237124">
<icon BUILTIN="button_ok"/>
<attribute NAME="EffortDone" VALUE="6" OBJECT="org.freeplane.features.format.FormattedNumber|6|#0.####"/>
<attribute NAME="ETC" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
</node>
<node TEXT="Task 2 50% complete" ID="ID_1319030829" CREATED="1484813796709" MODIFIED="1484816248431">
<icon BUILTIN="50%"/>
<attribute NAME="EffortDone" VALUE="3" OBJECT="org.freeplane.features.format.FormattedNumber|3|#0.####"/>
<attribute NAME="ETC" VALUE="3" OBJECT="org.freeplane.features.format.FormattedNumber|3|#0.####"/>
</node>
<node TEXT="" ID="ID_1711705003" CREATED="1484814121227" MODIFIED="1484814121227"/>
<node TEXT="Task 3 25% complete" ID="ID_1157274231" CREATED="1484813796709" MODIFIED="1484816276017">
<icon BUILTIN="25%"/>
<attribute NAME="EffortDone" VALUE="3" OBJECT="org.freeplane.features.format.FormattedNumber|3|#0.####"/>
<attribute NAME="ETC" VALUE="12" OBJECT="org.freeplane.features.format.FormattedNumber|12|#0.####"/>
</node>
</node>
<node TEXT="Subsequent Phase" LOCALIZED_STYLE_REF="default" FOLDED="true" ID="ID_1391181061" CREATED="1484731871164" MODIFIED="1484817194965" HGAP_QUANTITY="111.59999467849758 pt" VSHIFT_QUANTITY="-6.29999969959259 pt">
<attribute_layout NAME_WIDTH="60.299997124672075 pt" VALUE_WIDTH="60.299997124672075 pt"/>
<attribute NAME="EstStart" VALUE="=parent.find{ it.text == node[&apos;Predecessors&apos;].to.text}.getAt(0)[&apos;EstFinish&apos;].to.date" OBJECT="org.freeplane.features.format.FormattedFormula|=parent.find{ it.text == node[&apos;Predecessors&apos;].to.text}.getAt(0)[&apos;EstFinish&apos;].to.date|dd-MM-yy"/>
<attribute NAME="EstEffort" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|##"/>
<attribute NAME="EstFinish" VALUE="=node[&apos;EstStart&apos;].to.date+node[&apos;EstEffort&apos;].to.num.intValue()" OBJECT="org.freeplane.features.format.FormattedFormula|=node[&apos;EstStart&apos;].to.date+node[&apos;EstEffort&apos;].to.num.intValue()|dd-MM-yy"/>
...
<node TEXT="Task 1 100% complete" ID="ID_720648082" CREATED="1484813796709" MODIFIED="1484816958868">
<icon BUILTIN="button_ok"/>
<attribute NAME="EffortDone" VALUE="12" OBJECT="org.freeplane.features.format.FormattedNumber|12|#0.####"/>
<attribute NAME="ETC" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
</node>
<node TEXT="Task 2 50% Complete" ID="ID_432758571" CREATED="1484813796709" MODIFIED="1484816968920">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="4" OBJECT="org.freeplane.features.format.FormattedNumber|4"/>
</node>
<node TEXT="Task 3 not started" ID="ID_309863076" CREATED="1484813796709" MODIFIED="1484816987058">
<attribute NAME="EffortDone" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<attribute NAME="ETC" VALUE="10" OBJECT="org.freeplane.features.format.FormattedNumber|10|#0.####"/>
</node>
</node>
<node TEXT="Task Name" ID="ID_1086419525" CREATED="1484813796709" MODIFIED="1484817076338">
<attribute NAME="EffortDone" VALUE="12" OBJECT="org.freeplane.features.format.FormattedNumber|12|#0.####"/>
<attribute NAME="ETC" VALUE="0" OBJECT="org.freeplane.features.format.FormattedNumber|0|#0.####"/>
<richcontent TYPE="NOTE">
...
<node TEXT="records the current state of completion of the task" FOLDED="true" ID="ID_408459404" CREATED="1484818849795" MODIFIED="1484819075477">
...
<node TEXT="EffortLeft" ID="ID_1407922562" CREATED="1484817477949" MODIFIED="1484819050669" MAX_WIDTH="155.6 pt"><richcontent TYPE="NOTE">
